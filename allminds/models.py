...
class Person(models.Model):
	...
	years_in_practice = models.CharField(max_length=50, null=True)
	year_graduated = models.CharField(max_length=50, null=True)
	license_n_state = models.CharField(max_length=50, null=True)
	...
	video_skype = models.CharField(max_length=50, null=True)
